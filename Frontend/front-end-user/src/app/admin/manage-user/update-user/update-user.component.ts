...
export class UpdateUserComponent implements OnInit {
  ...
  get intakeCode() {
    return this.rfUpdateUser.get('intakeCode');
  }
  ...
  initForm() {
    this.rfUpdateUser = this.fb.group({
      ...
      intakeCode: [this.user.intake?.intakeCode, Validators.required],
  ...
  onSubmit() {
    ...
    const userUpdate: UserUpdate = new UserUpdate(this.username.value, this.email.value, this.password.value, profile, this.intakeCode.value);
